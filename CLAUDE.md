...
- **NSFC proposals (SSOT)** -- `proposal/source/**` is authoritative; `proposal/output/**` is derived; pass NSFC compliance/evidence/consistency/humanizer gates before export
...
├── proposal/                    # NSFC proposal SSOT workspace (Markdown+YAML)
